...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // We don't have a real backend connected in this Vite demo, so we'll just mock it
      // alertText.textContent = 'Demo Mode: Authentication successful!';
      localStorage.setItem('isLoggedIn', 'true');
      navigate('/dashboard'); // assuming there's a dashboard
    ...
    <div className="min-h-screen flex items-center justify-center relative p-6 bg-[#E0E5EC] text-[#3D4852] font-body overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-[32px] p-8 md:p-10 neo-extruded bg-[#E0E5EC] space-y-6 z-10 relative">
        ...
        <div className="space-y-3">
          <button className="w-full py-3 px-4 rounded-2xl text-xs font-bold bg-[#E0E5EC] neo-extruded hover:shadow-neo-lifted active:shadow-neo-inset text-[#3D4852] flex items-center justify-center gap-3 transition-all cursor-pointer font-body border border-white/40">
